...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\t\tif($(\"#messageByTopic\").val() == \"1\"){\n");
      out.write("\t\t\t $(\"#messageByTopic\").val(\"\");\n");
      out.write("\t\t\t $(\"#wenzhang\").click();\n");
      out.write("\t\t}\n");
      out.write("\t\t\n");
      out.write("\t\t//首页宣传图片添加或修改成功后的跳转\n");
      out.write("\t\tif($(\"#messageByImg\").val() == \"1\"){\n");
      out.write("\t\t\t$(\"#messageByImg\").val(\"\");\n");
      out.write("\t\t\t$(\"#HeadImg\").click();\n");
      out.write("\t\t}\n");
      out.write("\t\t\n");
      out.write("\t\tif($(\"#message2\").val() == \"2\"){\n");
      out.write("\t\t\t$(\"#message2\").val(\"\");\n");
      ...
      out.print(request.getContextPath());
      out.write("\"/>\n");
      out.write("<input type=\"hidden\" id=\"messageByTopic\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${messageByTopic }", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("\"/>\n");
      out.write("<input type=\"hidden\" id=\"messageByImg\" value=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${messageByImg }", java.lang.String.class, (PageContext)_jspx_page_context, null));
      out.write("\"/>\n");
      ...
      if (_jspx_eval_c_if_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("\t\t\t\t\t\t</li>\n");
          out.write("\t\t\t\t\t\t<li>\n");
          out.write("\t\t\t\t\t\t\t<a id=\"HeadImg\" class=\"ajaxify\" href=\"");
          out.print(request.getContextPath() );
          out.write("/admin/pic/indexPics\">\n");
          out.write("\t\t\t\t\t\t\t<i class=\"icon-wallet\"></i>\n");
          out.write("\t\t\t\t\t\t\t首页宣传图片管理</a>\n");
          out.write("\t\t\t\t\t\t</li>\n");
          out.write("\t\t\t\t\t\t<li>\n");
          out.write("\t\t\t\t\t\t\t<a class=\"ajaxify\" href=\"");
          out.print(request.getContextPath() );
          out.write("/admin/pic/newPics\">\n");
          out.write("\t\t\t\t\t\t\t<i class=\"icon-wallet\"></i>\n");
          out.write("\t\t\t\t\t\t\t首页新闻图片管理</a>\n");
          out.write("\t\t\t\t\t\t</li>\n");
          out.write("\t\t\t\t\t\t<li>\n");
          out.write("\t\t\t\t\t\t\t<a class=\"ajaxify\" href=\"");
          out.print(request.getContextPath() );
