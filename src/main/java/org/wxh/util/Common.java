...
public class Common {
	...
	public static String getcookie(HttpServletRequest request,String name) {
		return getcookiehasreturn(request,name,"");
	}
	/**
	 * 获取cookie
	 * 
	 ...
	 * @return
	 */
	public static String getcookiehasreturn(HttpServletRequest request,String name,String returnvalue) {
		Cookie[] cookies = request.getCookies();
		if(null==cookies) return returnvalue;
	...
	/**
	 * 返回当前开始时间　格式：yyyy-MM-dd hh:mm:ss
	 * @return String
	 */
	public static String fromDateStartH(){
		DateFormat format1 = new SimpleDateFormat("yyyy-MM-dd");
		return format1.format(new Date())+" 00:00";
	}
	/**
	 * 返回当前结束时间　格式：yyyy-MM-dd hh:mm:ss
	 * @return String
	 */
	public static String fromDateEndH(){
		DateFormat format1 = new SimpleDateFormat("yyyy-MM-dd");
		return format1.format(new Date())+" 23:59";
	}
	/**
