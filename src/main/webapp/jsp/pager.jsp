...
<pg:pager export="curPage=pageNumber" 
	...
	共
	<pg:last>
		${pageNumber } 页[${param.totalRecord }条记录],每页显示<%=SystemContext.getPageSize() %>条数据
	</pg:last>
	...
	<div class="btn-group">
		<pg:first>
			<a href="${pageUrl }" class="btn btn-default ajaxify">首页</a>
		</pg:first>
		<pg:prev>
			<a href="${pageUrl }" class="btn btn-default ajaxify">上一页</a>
		</pg:prev>
		<pg:pages>
		...
		<pg:next>
			<a href="${pageUrl }" class="btn btn-default ajaxify">下一页</a>
		</pg:next>
		<pg:last>
			<a href="${pageUrl }" class="btn btn-default ajaxify">尾页</a>
		</pg:last>
	</div>
</pg:pager>