...
var Layout = function () {
    ...
    var handleSidebarMenu = function () {
        jQuery('.page-sidebar').on('click', 'li > a', function (e) {
            ...
            if ($(this).next().hasClass('sub-menu') === false) {
                if (Metronic.getViewPort().width < 992) { // close the menu on
															// mobile view while
															// laoding a page
        ...
        jQuery('.page-content').on('submit', 'form.ajaxiform', function (e) {
            e.preventDefault();
            Metronic.scrollTop();
        ...
        jQuery('.page-content').on('submit', 'form.ajaxiform_file', function (e) {
            e.preventDefault();
            Metronic.scrollTop();
            Metronic.startPageLoading();
            var pageContent = $('.page-content');
    ...
    var handle100HeightContent = function () {
        ...
        if (target.hasClass('portlet')) {
            ...
            if (Metronic.getViewPort().width < 992) {
                Metronic.destroySlimScroll(portletBody.find('.full-height-content-body')); // destroy
																							// slimscroll
                return;
            }
            ...
            if (Metronic.getViewPort().width < 992) {
                Metronic.destroySlimScroll(target.find('.full-height-content-body')); // destroy
																						// slimscroll
                return;
            }
