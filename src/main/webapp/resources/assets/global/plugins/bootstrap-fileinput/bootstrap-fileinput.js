...
+function ($) { "use strict";
  ...
  var Fileupload = function (element, options) {
    ...
    this.$hidden = this.$element.find('input[type=hidden][name="'+this.name+'-hide"]')
    if (this.$hidden.length === 0) {
      this.$hidden = $('<input type="hidden" name="'+this.name+'-hide" />')
  ...
  Fileupload.prototype.clear = function(e) {
    ...
    this.$hidden.val('')
    this.$hidden.attr('name', this.name+"-hide")
